...
public class CancelOrder extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException 
	{
		...
		try (Connection con = DbConnection.getConnection())
		{
			...
			String myuserid= req.getParameter("userid");
			
			String sql = "DELETE FROM orders WHERE pid = ? AND uid=? " ;
			//String sql2 = "DELETE FROM products WHERE id = ?";		
			 ...
			 ps.setInt(2, Integer.parseInt(myuserid));
			...
			// int count2=ps2.executeUpdate();
			 ...
			 if(count>0)
			 {
	                ...
	                out.println("alert('Order Cancel Successfull!');");
	                out.println("</script>");
