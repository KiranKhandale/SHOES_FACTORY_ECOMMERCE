...
@WebServlet("/Customer/UserDisplayCasual")

public class UserDisplayCasual extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
	{
        ...
        try (Connection con = DbConnection.getConnection())
        {
        	 ...
        	 String query = "SELECT id, product_name, description, category, price, status, image FROM products where category='casual'";
          ...
          // Iterate through the result set and populate the product list
             ...
             RequestDispatcher rd = req.getRequestDispatcher("UserDisplayCasual.jsp");
             rd.forward(req, res);
        }
