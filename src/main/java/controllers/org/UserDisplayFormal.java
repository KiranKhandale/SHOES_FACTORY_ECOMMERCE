...
@WebServlet("/Customer/UserDisplayFormal")

public class UserDisplayFormal extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
	{
        ...
        try (Connection con = DbConnection.getConnection())
        {
        	 ...
        	 String query = "SELECT id, product_name, description, category, price, status, image FROM products where category='Formal'";
