...
@WebServlet("/Customer/UserDisplaySports")

public class UserDisplaySports extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
	{
        ...
        try (Connection con = DbConnection.getConnection())
        {
        	 ...
        	 String query = "SELECT id, product_name, description, category, price, status, image FROM products where category='sports'";
          ...
          // Iterate through the result set and populate the product list
             ...
             RequestDispatcher rd = req.getRequestDispatcher("UserDisplaySports.jsp");
             rd.forward(req, res);
        }
